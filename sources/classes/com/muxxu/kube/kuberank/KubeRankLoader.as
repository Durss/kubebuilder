package com.muxxu.kube.kuberank {
	 ...
	 * @date 26 juin 2011;
	 */
	public class KubeRankLoader extends MovieClip {
		 ...
		 * *********** */
		/**
		 * Creates an instance of <code>KubeRankLoader</code>.
		 */
		public function KubeRankLoader() {
			initialize();
		}
		...
		private function launch():void {
			// on frame 2
			var mainClass:Class = Class(getDefinitionByName("com.muxxu.kube.kuberank.KubeRank"));
			if(mainClass && !_error) {
