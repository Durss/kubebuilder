	...
	public class KubeView extends AbstractView {
		...
		override public function update(event:IModelEvent):void {
			...
			if(!_initialized || model.kubeData.faceTop != _lastTopFace) {
				...
				_initialized = true;
				_kube.leftFace = new CubeFace(model.kubeData.faceLeft, true);
				_kube.rightFace = new CubeFace(model.kubeData.faceRight);
				_kube.frontFace = new CubeFace(model.kubeData.faceFront, true);
				_kube.backFace = new CubeFace(model.kubeData.faceBack);
				_kube.topFace = new CubeFace(model.kubeData.faceTop, false, false, true); 
