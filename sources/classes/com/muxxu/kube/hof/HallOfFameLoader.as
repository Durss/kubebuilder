package com.muxxu.kube.hof {
	 ...
	 * @date 26 juin 2011;
	 */
	public class HallOfFameLoader extends MovieClip {
		 ...
		 * *********** */
		/**
		 * Creates an instance of <code>HallOfFameLoader</code>.
		 */
		public function HallOfFameLoader() {
			initialize();
		}
		...
		private function launch():void {
			// on frame 2
			var mainClass:Class = Class(getDefinitionByName("com.muxxu.kube.hof.HallOfFame"));
			if(mainClass && !_error) {
